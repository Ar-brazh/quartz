...
# Intitulés spécifiques alternance/apprentissage ajoutés à la recherche.
# Ils restent distincts des stages : le filtre continue d'exclure stage/internship.
ALTERNANCE_ROLE_TITLES: List[str] = [
    "alternance IA santé", "alternance intelligence artificielle santé",
    "alternance computer vision santé", "alternance deep learning imagerie médicale",
    "alternance segmentation imagerie médicale", "alternance PyTorch imagerie médicale",
    "alternance TensorFlow imagerie médicale", "alternance MONAI",
    "alternance ingénieur IA médicale", "alternance ingénieur imagerie médicale",
    "alternance ingénieur traitement d'images médicales",
    "alternance ingénieur logiciel scientifique", "alternance ingénieur R&D imagerie médicale",
    "alternance data scientist santé", "alternance machine learning santé",
    "apprentissage IA santé", "apprentissage computer vision santé",
    "apprentissage deep learning imagerie médicale", "apprenticeship medical imaging",
    "apprenticeship healthcare AI", "apprenticeship computer vision healthcare",
    "apprenticeship medical image segmentation",
]


# Cartographie ajoutée après recherche des métiers les plus demandés en innovation médicale
# France/Suisse : sert à enrichir la recherche, le scoring et l'analyse des offres.
INNOVATION_MEDICAL_ROLE_FAMILIES: Dict[str, List[str]] = {
    "logiciel_scientifique_ia_sante": [
        "ingénieur logiciel scientifique", "scientific software engineer",
        "research software engineer", "ingénieur python santé", "medical python engineer",
        "software engineer medical device", "healthcare software engineer",
        "ingénieur IA santé", "AI healthcare engineer", "machine learning engineer medical imaging",
    ],
    "imagerie_medicale_traitement_images": [
        "ingénieur imagerie médicale", "medical imaging engineer",
        "ingénieur traitement d'images médicales", "medical image processing engineer",
        "ingénieur analyse d'images", "image processing engineer", "neuroimaging engineer",
        "ingénieur neuroimagerie", "CT imaging engineer", "MRI imaging engineer",
    ],
    "phd_recherche_medicale": [
        "PhD medical imaging", "doctorant imagerie médicale", "PhD biomedical imaging",
        "PhD biomechanics", "doctorant biomécanique", "PhD AI healthcare",
        "doctorant IA santé", "doctoral candidate medical imaging",
    ],
    "biomedical_clinique_applications": [
        "ingénieur biomédical", "biomedical engineer", "clinical engineer",
        "ingénieur application clinique", "clinical application specialist",
        "clinical applications engineer", "field clinical engineer",
    ],
    "systemes_validation_dispositifs_medicaux": [
        "ingénieur systèmes dispositifs médicaux", "medical device systems engineer",
        "ingénieur validation dispositif médical", "verification validation engineer medical device",
        "V&V engineer medical device", "quality engineer medical device",
        "regulatory affairs medical device", "ingénieur qualité dispositifs médicaux",
    ],
    "radiotherapie_dosimetrie_radioprotection": [
        "ingénieur dosimétrie", "dosimetry engineer", "ingénieur radiothérapie",
        "radiotherapy engineer", "medical physicist", "ingénieur radioprotection",
        "dose metrology engineer",
    ],
    "instrumentation_plateformes_experimentation": [
        "ingénieur instrumentation biomédicale", "biomedical instrumentation engineer",
        "ingénieur plateforme expérimentale", "experimental platform engineer",
        "test engineer medical device", "ingénieur banc d'essai médical",
    ],
    "alternance_ia_medicale": ALTERNANCE_ROLE_TITLES,
}

# Classement exploitable des compétences demandées. Le champ demand_weight est utilisé comme bonus de scoring.
DEMAND_SKILL_RANKING: List[Dict[str, object]] = [
    {"rank": 1, "skill": "Python", "demand": "très forte", "demand_weight": 5.0, "keywords": ["python", "scripting python", "py"]},
    {"rank": 2, "skill": "IA / Machine Learning / Deep Learning", "demand": "très forte", "demand_weight": 4.8, "keywords": ["machine learning", "deep learning", "ai", "ia", "foundation model", "modèle fondationnel", "few-shot", "pytorch", "tensorflow"]},
    {"rank": 3, "skill": "Imagerie médicale", "demand": "très forte", "demand_weight": 4.7, "keywords": ["medical imaging", "imagerie médicale", "ct", "scanner", "mri", "irm", "pet", "tep", "ultrasound", "échographie"]},
    {"rank": 4, "skill": "Traitement d'images / segmentation / recalage", "demand": "très forte", "demand_weight": 4.5, "keywords": ["image processing", "traitement d'image", "segmentation", "registration", "recalage", "computer vision"]},
    {"rank": 5, "skill": "C++ / C / logiciel embarqué", "demand": "forte", "demand_weight": 3.8, "keywords": ["c++", "cpp", " c ", "embedded", "firmware", "logiciel embarqué"]},
    {"rank": 6, "skill": "Validation, tests, V&V", "demand": "forte", "demand_weight": 3.7, "keywords": ["verification", "validation", "v&v", "test", "tests logiciels", "pytest", "unit test", "integration test"]},
    {"rank": 7, "skill": "Dispositifs médicaux / ISO 13485 / MDR", "demand": "forte", "demand_weight": 3.6, "keywords": ["medical device", "dispositif médical", "iso 13485", "mdr", "2017/745", "regulatory"]},
    {"rank": 8, "skill": "Traitement du signal", "demand": "forte", "demand_weight": 3.2, "keywords": ["signal processing", "traitement du signal", "fft", "filtering", "filtrage"]},
    {"rank": 9, "skill": "Biomécanique / modélisation / simulation", "demand": "moyenne à forte", "demand_weight": 3.0, "keywords": ["biomechanics", "biomécanique", "modeling", "modélisation", "simulation", "sofa"]},
    {"rank": 10, "skill": "Robotique médicale / ROS / contrôle", "demand": "moyenne à forte", "demand_weight": 2.8, "keywords": ["medical robotics", "robotique médicale", "ros", "control", "contrôle", "trajectory"]},
    {"rank": 11, "skill": "Clinical application / communication clinique", "demand": "moyenne à forte", "demand_weight": 2.5, "keywords": ["clinical application", "application clinique", "clinical", "clinique", "hospital", "hôpital"]},
    {"rank": 12, "skill": "Qualité / affaires réglementaires", "demand": "moyenne à forte", "demand_weight": 2.4, "keywords": ["quality", "qualité", "regulatory affairs", "affaires réglementaires", "risk management", "iso 14971"]},
    {"rank": 13, "skill": "Instrumentation / bancs d'essais", "demand": "moyenne", "demand_weight": 2.2, "keywords": ["instrumentation", "test bench", "banc d'essai", "prototype", "experimental platform", "plateforme expérimentale"]},
    {"rank": 14, "skill": "Git / CI-CD / DevOps", "demand": "moyenne", "demand_weight": 2.0, "keywords": ["git", "github", "gitlab", "ci/cd", "devops", "azure devops"]},
    {"rank": 15, "skill": "Documentation technique / anglais scientifique", "demand": "moyenne", "demand_weight": 1.8, "keywords": ["technical writing", "documentation technique", "english", "anglais", "scientific writing"]},
]

# Enrichit automatiquement les intitulés ciblés avec la cartographie ci-dessus.
for _family_roles in INNOVATION_MEDICAL_ROLE_FAMILIES.values():
    for _role in _family_roles:
        if _role not in TARGET_ROLE_TITLES:
            TARGET_ROLE_TITLES.append(_role)


TARGET_TITLE_TERMS: Dict[str, List[str]] = {
    "role": ["ingénieur", "ingenieur", "engineer", "développeur", "developpeur", "developer", "scientist", "chercheur", "research", "software", "alternance", "apprentissage", "apprenticeship"],
...
MARKETPLACE_SEARCH_TEMPLATES: Dict[str, str] = {
    ...
    "welcometothejungle": "https://www.welcometothejungle.com/fr/jobs?query={query}&aroundQuery={location}",
    "welcome": "https://www.welcometothejungle.com/fr/jobs?query={query}&aroundQuery={location}",
}
...
def detect_source_type(url: str) -> str:
    ...
    if "welcometothejungle." in host or "welcomekit." in host: return "welcometothejungle"
...
def is_probable_career_page(url: str, title: str, text: str) -> Tuple[bool, float, str]:
    ...
    if source_type in {"linkedin", "indeed", "hellowork", "welcometothejungle", "ats"}:
...
GOOD_JOB_URL_PATTERNS = [
    ...
    r"welcometothejungle\.com/.+/jobs/.+", r"welcometothejungle\.com/.+/companies/.+/jobs/.+",
    r"\.pdf(?:$|[?#])",
]
...
# exclusion stage/senior/responsable, exclusion doctorat demandé
# (les offres de PhD et d'alternance ciblée restent autorisées), exclusion > 5 ans d'expérience.
...
# Termes IA/ML optionnels : utiles si vous voulez chercher des postes pour monter en
# compétence en IA médicale, mais désactivables si vous ne voulez pas cibler des offres
# qui demandent déjà une expérience IA explicite.
AI_KEYWORD_TERMS = [
    "ia", "ai", "intelligence artificielle", "artificial intelligence",
    "machine learning", "deep learning", "apprentissage automatique",
    "apprentissage profond", "pytorch", "tensorflow", "monai",
    "foundation model", "modèle fondationnel", "modeles fondationnels",
    "ml engineer", "ai engineer", "ingénieur ia", "ingenieur ia",
]

EXCLUDED_ROLE_TERMS = [
    "stage", "stagiaire", "internship", "intern ", "senior", "sr.", "lead ", "principal",
...
def same_domain_or_ats(source_url: str, candidate_url: str) -> bool:
    ...
    ats_domains = [
        ...
        "linkedin.com", "indeed.com", "indeed.fr", "hellowork.com", "welcometothejungle.com",
    ]
...
def is_alternance_offer(title: str, text: str = "", contract_type: str = "") -> bool:
    haystack = normalize_for_match(f"{title} {contract_type} {text[:2000]}")
    terms = ["alternance", "apprentissage", "apprenticeship", "contrat d'apprentissage", "contrat de professionnalisation", "contrat pro"]
    return any(normalize_for_match(term) in haystack for term in terms)


def contains_ai_keyword(value: str) -> bool:
    """Détecte les mots-clés IA/ML explicites dans un intitulé ou une requête."""
    haystack = f" {normalize_for_match(value)} "
    for term in AI_KEYWORD_TERMS:
        t = normalize_for_match(term)
        if not t:
            continue
        # IA/AI sont très courts : on impose des frontières de mots pour éviter les faux positifs.
        if t in {"ia", "ai"}:
            if re.search(rf"(?<![a-z0-9]){re.escape(t)}(?![a-z0-9])", haystack, flags=re.I):
                return True
        elif t in haystack:
            return True
    return False
...
def filter_ai_role_queries(role_queries: Sequence[str], include_ai_keywords: bool) -> List[str]:
    """Supprime les requêtes IA/ML si l'option --exclude-ai-keywords est activée."""
    if include_ai_keywords:
        return list(role_queries)
    return [q for q in role_queries if not contains_ai_keyword(q)]
...
def passes_job_constraints(title: str, text: str, location: str, contract_type: str, published_at: str, published_year: Optional[int], allow_unknown_published_date: bool, allowed_country_terms: Sequence[str], max_experience_years: int = 5, include_alternance: bool = True, include_ai_keywords: bool = True) -> Tuple[bool, str]:
    haystack = normalize_for_match(f"{title} {contract_type} {text[:6000]}")
    phd_offer = is_phd_offer(title, text)
    alternance_offer = is_alternance_offer(title, text, contract_type)

    if alternance_offer and not include_alternance:
        return False, "Alternance exclue par option --no-alternance."

    if not include_ai_keywords and contains_ai_keyword(f"{title} {contract_type}"):
        return False, "Mot-clé IA/ML exclu par option --exclude-ai-keywords."

    # Exclusions stage/senior/responsable/manager ; PhD et alternance ciblée conservés.
    if not phd_offer:
...
def find_demand_skill_matches(text: str) -> List[Dict[str, object]]:
    """Retourne les compétences de la cartographie marché détectées dans une offre."""
    haystack = normalize_for_match(f" {text or ''} ")
    hits: List[Dict[str, object]] = []
    for item in DEMAND_SKILL_RANKING:
        for kw in item.get("keywords", []):
            kw_l = normalize_for_match(str(kw))
...
def demand_skill_bonus(text: str) -> float:
    """Bonus modéré : favorise les offres alignées avec les compétences les plus demandées."""
    hits = find_demand_skill_matches(text)
    return min(10.0, sum(float(h.get("demand_weight", 0.0)) for h in hits) * 0.45)


def print_demand_skill_ranking() -> None:
    print("\nClassement des compétences demandées en innovation médicale (France/Suisse)\n")
    for item in DEMAND_SKILL_RANKING:
        print(f"{item['rank']:>2}. {item['skill']} — {item['demand']}")
    print("")


def print_target_role_families() -> None:
    print("\nFamilles de métiers ciblées en innovation médicale\n")
    for family, roles in INNOVATION_MEDICAL_ROLE_FAMILIES.items():
        print(f"- {family}:")
...
def score_against_profile(title: str, text: str) -> Dict[str, object]:
    ...
    raw += demand_skill_bonus(full_text)
...
def read_sources(input_path: Optional[Path], urls: Sequence[str]) -> List[Tuple[str, str]]:
    ...
    linkedin_jobs_url, indeed_jobs_url, hellowork_jobs_url, welcome_jobs_url.
    """
    sources: List[Tuple[str, str]] = []
    for u in urls:
...
def crawl_source(
    ...
    include_alternance: bool,
    include_ai_keywords: bool,
) -> None:
    ...
    for api_url in discover_ats_api_urls(source_url):
        ...
        for job in parse_ats_json(api_url, payload, company, source_url):
            ok_constraints, why_constraints = passes_job_constraints(
                ...
                published_year, allow_unknown_published_date, allowed_country_terms, include_alternance=include_alternance, include_ai_keywords=include_ai_keywords,
            )
    ...
    while queue:
        ...
        for link in extract_links(current_url, html_text):
            ...
            recruitment_hint = any(h in link_l for h in [
                ...
                "linkedin", "indeed", "hellowork", "welcometothejungle", "welcome", ".pdf",
            ])
...
def build_arg_parser() -> argparse.ArgumentParser:
    ...
    p.add_argument("--include-marketplaces", action="store_true", help="Ajoute des recherches LinkedIn, Indeed, HelloWork et Welcome to the Jungle à partir des intitulés ciblés.")
    p.add_argument("--marketplaces", nargs="+", default=["hellowork", "indeed", "linkedin", "welcometothejungle"], help="Job boards à utiliser: hellowork indeed linkedin welcometothejungle/welcome.")
    ...
    p.add_argument("--no-alternance", action="store_true", help="Désactive la recherche et la conservation des offres d'alternance/apprentissage.")
    p.add_argument("--exclude-ai-keywords", action="store_true", help="Exclut les requêtes et offres dont l'intitulé contient IA/AI/ML/deep learning/PyTorch/TensorFlow/MONAI. Utile si vous voulez viser imagerie/logiciel/R&D sans prérequis IA explicite.")
    ...
    p.add_argument("--print-demand-skills", action="store_true", help="Affiche le classement des compétences demandées puis quitte.")
    p.add_argument("--print-target-roles", action="store_true", help="Affiche les familles de métiers ciblées puis quitte.")
    return p
...
def main(argv: Optional[Sequence[str]] = None) -> int:
    ...
    if args.print_demand_skills:
        print_demand_skill_ranking()
        return 0
    if args.print_target_roles:
        print_target_role_families()
        return 0
    ...
    if args.include_marketplaces:
        role_queries = list(args.role_query or TARGET_ROLE_TITLES)
        if not args.no_alternance:
            for q in ALTERNANCE_ROLE_TITLES:
                if q not in role_queries:
                    role_queries.append(q)
        else:
            role_queries = [q for q in role_queries if not is_alternance_offer(q)]
        role_queries = filter_ai_role_queries(role_queries, include_ai_keywords=not args.exclude_ai_keywords)
    ...
    print(f"   Alternance/apprentissage: {'exclu' if args.no_alternance else 'inclus'}")
    print(f"   Mots-clés IA/ML: {'exclus' if args.exclude_ai_keywords else 'inclus'}")
    if published_year:
    ...
    print("   Exclusions: stage/senior/responsable, >5 ans d'expérience, doctorat requis hors offres PhD")
    ...
    for company, source_url in sources:
        try:
            crawl_source(
                ...
                include_alternance=not args.no_alternance,
                include_ai_keywords=not args.exclude_ai_keywords,
            )
